...
public class addlink2 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//*[@id=\"text-resize\"]/header/div[1]/div[1]/div/ul/li[6]/a")).click();
		common.checkPageIsReady(driver);
		...
		driver.findElement(By.xpath("//input[@id='adminEmployee.emppassword']")).sendKeys("Abm@1234");
		Thread.sleep(1000);
