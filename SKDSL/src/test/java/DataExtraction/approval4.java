...
public class approval4 {
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		WebElement element = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@id=\"gridSectionDetailsApp\"]/tbody/tr[2]/td[6]/form/a")));
		...
		for (int i = 0; i < rowc; i++) {
			...
			System.out.println("##############################"
					+ driver.findElement(By.xpath(XPath + "/td[2]")).getText().toString());
			if (driver.findElement(By.xpath(XPath + "/td[1]")).getText().toString().equalsIgnoreCase("Smart City")) {
				System.out.println(
		...
		////////////////////////////////////////////////////////////////////////////////////
		// C:\Users\swapnil.patil\Desktop\SKDSL\Data\Home Organisation ST Resolution ST
		//////////////////////////////////////////////////////////////////////////////////// Resolution
		//////////////////////////////////////////////////////////////////////////////////// 1995
		//////////////////////////////////////////////////////////////////////////////////// 96
		//////////////////////////////////////////////////////////////////////////////////// xcel
		...
		for (int i = 0; i < 2885; i++) {
			...
			wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("input[type=\"submit\"][value=\"Submit\"]")));
			wait.until(ExpectedConditions
					.presenceOfElementLocated(By.cssSelector("input[type=\"submit\"][value=\"Submit\"]")));
			wait.until(ExpectedConditions
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.id("entity.chekkerflag1")));
			wait.until(ExpectedConditions.elementToBeClickable(By.id("entity.chekkerflag1")));
Thread.sleep(500);
